...
public class View implements Observer {
	TelegramBot bot = TelegramBotAdapter.build("xx");
				...
				bola = false;
				 ...
				 if(resp == null){
						...
						for(Hospital hosp:hospitais){
							...
							Double dist = calcularDistancia(loc, hosp.getLocalizacao());
...
+"º Levar a vítima ao pronto-socorro.").replyMarkup(sangramento));
	...
	public static double calcularDistancia(LatLng StartP, LatLng EndP) {
